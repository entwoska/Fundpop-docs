...
* [💡 About Fundpop](README.md)
* [✨ Key Features](introduction/key-features.md)

## Getting Started

* [👋 Install Fundpop](getting-started/install-fundpop.md)
* [💰 Creating Your First Campaign](getting-started/creating-your-first-campaign.md)
* [📈 Dashboard Overview](getting-started/dashboard-overview.md)

## CUSTOMIZATIONS

* [🎨 Fundpop Widget Templates](customizations/fundpop-widget-templates.md)
* [➕ Extended Widget Placement](customizations/extended-widget-placement.md)
...
* [🏆 Milestones](advanced-features/milestones.md)
* [📈 Reward tiers](advanced-features/reward-tiers.md)
